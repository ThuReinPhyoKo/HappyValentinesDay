...
export default function Letter() {
    ...
    return (
        <section className="w-full min-h-screen p-3 flex flex-col items-center justify-center -mt-px border-0 bg-[linear-gradient(to_bottom,#7aa1d2,#dfd3dd)]">
            <Image src="/svg/letter.svg" width="80" height="80" alt="letter-svg" />
            <h1 className="p-1 mb-4 md:h-24 text-5xl md:text-7xl font-romantic font-semibold text-gradient-reason">A Letter For You</h1>
